...
extensions = ext/-test-/array/resize/. ext/-test-/bug-3571/. \
	     ...
	     ext/-test-/string/. ext/-test-/symbol/. \
	     ext/-test-/typeddata/. ext/-test-/wait_for_single_fd/. \
	     ext/-test-/win32/dln/. ext/-test-/win32/fd_setsize/. \
	     ext/bigdecimal/. ext/continuation/. ext/coverage/. \
	     ext/curses/. ext/date/. ext/dbm/. ext/digest/. \
	     ...
	     ext/fcntl/. ext/fiber/. ext/fiddle/. ext/fiddle/win32/. \
	     ext/gdbm/. ext/io/console/. ext/io/nonblock/. \
	     ...
	     ext/psych/. ext/pty/. ext/racc/cparse/. ext/readline/. \
	     ext/ripper/. ext/sdbm/. ext/socket/. ext/stringio/. \
	     ext/strscan/. ext/syslog/. ext/tk/. ext/tk/tkutil/. \
	     ext/win32ole/. ext/zlib/.
EXTOBJS = dmyext.o
EXTLIBS =
EXTLDFLAGS =
